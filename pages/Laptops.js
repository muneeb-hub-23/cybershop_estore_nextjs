  ...
  return (
    ...
    <div class="container px-5 py-24 mx-auto">
      <div class="flex flex-wrap -m-4">
        ...
        <div class="lg:w-1/4 md:w-1/2 p-4 w-full">
          <a class="block relative h-48 rounded overflow-hidden">
            <img alt="ecommerce" class="object-cover object-center w-full h-full block" src="https://basitLaptops.com/wp-content/uploads/2022/09/i5-4th-generation-tower-pc-with-gtx-660-2gb-rgb-gaming-case-custom-build-pc.jpg" />
          </a>
          <div class="mt-4">
            <h3 class="text-gray-500 text-xs tracking-widest title-font mb-1">Laptops</h3>
            <h2 class="text-gray-900 title-font text-lg font-medium">Dell Core i5 6th gen</h2>
